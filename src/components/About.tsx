    ...
    <section id="about" className="section">
      <div ref={ref} className="shell grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
        <div className="max-w-[34rem]">
          ...
          <h2 data-reveal className="t-h2 mt-4">
            {about.h2}
          </h2>
          <p data-reveal className="t-lead mt-5">
            {about.sub}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {about.points.map((p, i) => (
            ...
            >
              <h3 className="text-[1.1rem] font-800 tracking-[-0.01em]">
                {p.title}
              </h3>
              <p className="t-serif mt-2 text-[0.96rem] leading-relaxed text-ink-soft">
                {p.body}
              </p>
            </div>
          ))}
